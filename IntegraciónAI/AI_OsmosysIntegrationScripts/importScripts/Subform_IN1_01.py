...
def importForm(month, month_number, year, test):
    ...
    for index, row in parentFormsIds.iterrows():
        ...
        subform = model.modelAI.SubFormIN1_01(
            ...
            poblacion_meta_freq='Recurrente',
            modalidad_impl='cmo12q1kykwwosjka',
            IN1_01_RM_MM_R=IN1_01_RM_MM_R,
            IN1_01_RM_HH_R=IN1_01_RM_HH_R,
            IN1_01_RM_OTR_R=IN1_01_RM_OTR_R,
            IN1_01_RM_LGBT_R=IN1_01_RM_LGBT_R,
            IN1_01_CA_MM_R=IN1_01_CA_MM_R,
            IN1_01_CA_HH_R=IN1_01_CA_HH_R,
            IN1_01_CA_OTR_R=IN1_01_CA_OTR_R,
            IN1_01_CA_LGBT_R=IN1_01_CA_LGBT_R,
