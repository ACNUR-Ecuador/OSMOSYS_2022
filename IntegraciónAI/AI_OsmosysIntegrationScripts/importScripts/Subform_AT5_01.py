...
def importForm(month, month_number, year, test):
    ...
    for index, row in parentFormsIds.iterrows():
        ...
        AT5_01_RM_NA_MN = int(df.loc[df['age_gender'] == 'NINAS'].iloc[0].value_a)
        AT5_01_RM_NN_MN = int(df.loc[df['age_gender'] == 'NINOS'].iloc[0].value_a)
        AT5_01_RM_MM_MN = int(df.loc[df['age_gender'] == 'ADULTAS'].iloc[0].value_a)
        AT5_01_RM_HH_MN = int(df.loc[df['age_gender'] == 'ADULTOS'].iloc[0].value_a)
        AT5_01_RM_OTR_MN = int(df.loc[df['age_gender'] == 'OTRO'].iloc[0].value_a)

        dfCa = osmosys.osmosys.getCAValues(year=year, month=month, orgOsmosys=orgAcron,
                                           indicatorsIdsOmosys=indicatorIdsOsmosys, cantonCode=cantonCode)
        AT5_01_CA_NA_MN = int(dfCa.loc[df['age_gender'] == 'NINAS'].iloc[0].value_a)
        AT5_01_CA_NN_MN = int(dfCa.loc[df['age_gender'] == 'NINOS'].iloc[0].value_a)
        AT5_01_CA_MM_MN = int(dfCa.loc[df['age_gender'] == 'ADULTAS'].iloc[0].value_a)
        AT5_01_CA_HH_MN = int(dfCa.loc[df['age_gender'] == 'ADULTOS'].iloc[0].value_a)
        AT5_01_CA_OTR_MN = int(dfCa.loc[df['age_gender'] == 'OTRO'].iloc[0].value_a)
        ...
        AT5_01_RM_LGBT_MN = int(dfDiversidad.loc[(dfDiversidad['diversity_type'] == 'LGBTI') & (
                dfDiversidad['country_of_origin'] == 'VENEZUELA')].iloc[0].value_a)

        AT5_01_CA_LGBT_MN = int(dfDiversidad.loc[(dfDiversidad['diversity_type'] == 'LGBTI') & (
                dfDiversidad['country_of_origin'] == 'ECUADOR')].iloc[0].value_a)

        subform = model.modelAI.SubFormAT5_01(
            mes=month_number,
            ...
            tipo_kit='Menaje de casa',
            AT5_01_RM_NA_MN=AT5_01_RM_NA_MN,
            AT5_01_RM_NN_MN=AT5_01_RM_NN_MN,
            AT5_01_RM_MM_MN=AT5_01_RM_MM_MN,
            AT5_01_RM_HH_MN=AT5_01_RM_HH_MN,
            AT5_01_RM_OTR_MN=AT5_01_RM_OTR_MN,
            AT5_01_RM_LGBT_MN=AT5_01_RM_LGBT_MN,
            AT5_01_CA_NA_MN=AT5_01_CA_NA_MN,
            AT5_01_CA_NN_MN=AT5_01_CA_NN_MN,
            AT5_01_CA_MM_MN=AT5_01_CA_MM_MN,
            AT5_01_CA_HH_MN=AT5_01_CA_HH_MN,
            AT5_01_CA_OTR_MN=AT5_01_CA_OTR_MN,
            AT5_01_CA_LGBT_MN=AT5_01_CA_LGBT_MN,
            AT5_01_CUAL=commentary
        )
        newId = generate_id()
        newIds.append(newId)
