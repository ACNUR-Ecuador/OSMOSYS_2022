...
def importForm(month, month_number, year, test):
    ...
    for index, row in parentFormsIds.iterrows():
        ...
        ED4_03_RM_NA = int(df.loc[df['age_gender'] == 'NINAS'].iloc[0].value_a)
        ED4_03_RM_NN = int(df.loc[df['age_gender'] == 'NINOS'].iloc[0].value_a)
        ED4_03_RM_MM = int(df.loc[df['age_gender'] == 'ADULTAS'].iloc[0].value_a)
        ED4_03_RM_HH = int(df.loc[df['age_gender'] == 'ADULTOS'].iloc[0].value_a)

        dfCa = osmosys.osmosys.getCAValues(year=year, month=month, orgOsmosys=orgAcron,
                                           indicatorsIdsOmosys=indicatorIdsOsmosys, cantonCode=cantonCode)
        ED4_03_CA_NA = int(dfCa.loc[df['age_gender'] == 'NINAS'].iloc[0].value_a)
        ED4_03_CA_NN = int(dfCa.loc[df['age_gender'] == 'NINOS'].iloc[0].value_a)
        ED4_03_CA_MM = int(dfCa.loc[df['age_gender'] == 'ADULTAS'].iloc[0].value_a)
        ED4_03_CA_HH = int(dfCa.loc[df['age_gender'] == 'ADULTOS'].iloc[0].value_a)
        ...
        subform = model.modelAI.SubFormED4_03(
            ...
            ED4_03_RM_NA=ED4_03_RM_NA,
            ED4_03_RM_NN=ED4_03_RM_NN,
            ED4_03_RM_MM=ED4_03_RM_MM,
            ED4_03_RM_HH=ED4_03_RM_HH,
            ED4_03_CA_NA=ED4_03_CA_NA,
            ED4_03_CA_NN=ED4_03_CA_NN,
            ED4_03_CA_MM=ED4_03_CA_MM,
            ED4_03_CA_HH=ED4_03_CA_HH,
