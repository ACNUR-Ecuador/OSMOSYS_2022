...
public class StandardDissagregationOptionDao extends GenericDaoJpa<StandardDissagregationOption, Long> {
    ...
    public List<StandardDissagregationOption> getActiveAgeOptionsByIndicatorExecutionId(Long indicatorExecutionId) throws GeneralAppException {
        State state=State.ACTIVO;
        String dissType="age";
        String sql = "SELECT DISTINCT o.id, o.group_name, o.name, o.order_, o.state, o.age_range " +
                "FROM dissagregations.standard_dissagregation_options o " +
                "LEFT JOIN osmosys.indicator_execution_location_assigments iela ON iela.canton_id=o.id " +
                " WHERE iela.indicator_execution_id=:indicatorExecutionId" +
                " AND o.type=:dissType" +
                " AND iela.state = :state";
        Query q = getEntityManager().createNativeQuery(sql,"StandardDissagregationOptionDTOMapping");
        q.setParameter("state", state);
        q.setParameter("dissType", dissType);
    ...
    public List<StandardDissagregationOption> getActivePopulationTypeActiveOptionsByIndicatorExecutionId(Long indicatorExecutionId) throws GeneralAppException {
        State state=State.ACTIVO;
        String dissType="age";
        String sql = "SELECT DISTINCT o.id, o.group_name, o.name, o.order_, o.state, o.age_range " +
                "FROM dissagregations.standard_dissagregation_options o " +
    ...
    public List<StandardDissagregationOption> getActiveGenderOptionsByIndicatorExecutionId(Long indicatorExecutionId) throws GeneralAppException {
        State state=State.ACTIVO;
        String dissType="age";
        String sql = "SELECT DISTINCT o.id, o.group_name, o.name, o.order_, o.state, o.age_range " +
                "FROM dissagregations.standard_dissagregation_options o " +
