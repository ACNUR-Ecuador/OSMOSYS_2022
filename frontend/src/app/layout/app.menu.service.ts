...
export class MenuService {
    ...
    MENUITEMS: Menu[] = [
        ...
        },
        {
            ...
            icon: 'pi pi-file-o',
            roles: ['SUPER_ADMINISTRADOR', 'ADMINISTRADOR_REGIONAL', 'ADMINISTRADOR_LOCAL', 'EJECUTOR_ID', 'MONITOR_ID', 'PUNTO_FOCAL', 'MONITOR_PROYECTOS', 'EJECUTOR_PROYECTOS','ADMINISTRADOR_OFICINA'],
