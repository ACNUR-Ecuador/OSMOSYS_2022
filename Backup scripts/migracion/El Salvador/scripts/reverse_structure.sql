...
/*-----standard_dissagregation_options------*/

ALTER TABLE "dissagregations"."standard_dissagregation_options" DROP COLUMN "region_group_name";

ALTER TABLE "dissagregations"."standard_dissagregation_options" DROP COLUMN "other_group_name";
