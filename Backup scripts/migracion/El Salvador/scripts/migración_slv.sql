...
INSERT INTO security.roleassigment(
	state, role_id, user_id)
	VALUES ('ACTIVO', (select id from security.role where tipo_rol = 'ADMINISTRADOR_REGIONAL'), (SELECT ID FROM security.user where username = 'pradoc'
));

INSERT INTO security.roleassigment(
	state, role_id, user_id)
	VALUES ('ACTIVO', (select id from security.role where tipo_rol = 'ADMINISTRADOR_REGIONAL'), (SELECT ID FROM security.user where username = 'guardado'
));


INSERT INTO security.roleassigment(
	state, role_id, user_id)
	VALUES ('ACTIVO', (select id from security.role where tipo_rol = 'ADMINISTRADOR_REGIONAL'), (SELECT ID FROM security.user where username = 'carranzf'
));


INSERT INTO security.roleassigment(
	state, role_id, user_id)
	VALUES ('ACTIVO', (select id from security.role where tipo_rol = 'ADMINISTRADOR_REGIONAL'), (SELECT ID FROM security.user where username = 'salazart'
));
...
SELECT  'TIME_ZONE', 'Zona horaria de la operación', 'Configuración de Zona horaria para la operación', 'America/El_Salvador'
WHERE NOT EXISTS (
